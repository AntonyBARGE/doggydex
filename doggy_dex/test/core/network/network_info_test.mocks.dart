...
class _FakeAddressCheckResult_1 extends i1.Fake
    implements i2.AddressCheckResult {}

/// A class which mocks [InternetConnectionChecker].
///
/// See the documentation for Mockito's code generation for more information.
class MockInternetConnectionChecker extends i1.Mock
    implements i2.InternetConnectionChecker {
  ...
  List<i2.AddressCheckOptions> get addresses =>
      (super.noSuchMethod(Invocation.getter(#addresses),
              returnValue: <i2.AddressCheckOptions>[])
          as List<i2.AddressCheckOptions>);
  @override
  set addresses(List<i2.AddressCheckOptions>? addresses) =>
      super.noSuchMethod(Invocation.setter(#addresses, addresses),
  ...
  @override
  set checkInterval(Duration? checkInterval) =>
      super.noSuchMethod(Invocation.setter(#checkInterval, checkInterval),
          returnValueForMissingStub: null);
  @override
  i3.Future<bool> get hasConnection =>
      (super.noSuchMethod(Invocation.getter(#hasConnection),
          returnValue: Future<bool>.value(false)) as i3.Future<bool>);
  @override
  i3.Future<i2.InternetConnectionStatus> get connectionStatus =>
      (super.noSuchMethod(Invocation.getter(#connectionStatus),
              returnValue: Future<i2.InternetConnectionStatus>.value(
                  i2.InternetConnectionStatus.connected))
          as i3.Future<i2.InternetConnectionStatus>);
  @override
  i3.Stream<i2.InternetConnectionStatus> get onStatusChange =>
      (super.noSuchMethod(Invocation.getter(#onStatusChange),
              returnValue: Stream<i2.InternetConnectionStatus>.empty())
  ...
  @override
  i3.Future<i2.AddressCheckResult> isHostReachable(
          i2.AddressCheckOptions? options) =>
      (super.noSuchMethod(Invocation.method(#isHostReachable, [options]),
              returnValue: Future<i2.AddressCheckResult>.value(
